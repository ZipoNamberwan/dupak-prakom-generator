                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Generate Bukti Fisik</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Generate Bukti Fisik Berdasarkan Periode</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form autocomplete="off" method="get" action="/IIB12/generate-by-periode" class="needs-validation" enctype="multipart/form-data" novalidate>
                            <div class="row">
