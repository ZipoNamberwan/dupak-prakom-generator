        ...
        <div class="col">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form autocomplete="off" method="post" action="/IB21" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
...
<script>
    function refreshAutoTitle() {
        ...
        if (auto.checked) {
            ...
            if (typeString != '')
                var autoTitleString = infraTypeString + infraNameString + roomString
            var title = document.getElementById('title')
