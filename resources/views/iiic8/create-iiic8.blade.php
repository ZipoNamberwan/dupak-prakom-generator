        ...
        <div class="col">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form autocomplete="off" method="post" action="/IIIC8" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control" id="data" name="data" rows="5">{{@old('data')}}</textarea>
                                            @error('data')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control" id="link" name="link" rows="5">{{@old('link')}}</textarea>
                                            @error('link')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
