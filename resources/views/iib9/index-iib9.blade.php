                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="{{url('/IIB9/generate-by-periode')}}" target="_blank" class="btn btn-outline-primary btn-round btn-icon mb-2" data-toggle="tooltip" data-original-title="Generate">
                            ...
                            <a href="{{url('/IIB9/create')}}" class="btn btn-primary btn-round btn-icon mb-2" data-toggle="tooltip" data-original-title="Tambah Kegiatan">
...
<script>
    var table = $('#datatable-id').DataTable({
        ...
        "columns": [{
            ...
            "data": "id",
            "render": function(data, type, row) {
                return "<a target=\"_blank\" href=\"/IIB9/" + data + "/generate\" class=\"btn btn-outline-success  btn-sm\" role=\"button\" aria-pressed=\"true\" data-toggle=\"tooltip\" data-original-title=\"Ubah Data\">" +
                    "<span class=\"btn-inner--icon\"><i class=\"fas fa-file-export\"></i></span></a>" +
                    "<a target=\"_blank\" href=\"/IIB9/" + data + "/generate-approval\" class=\"btn btn-outline-warning  btn-sm\" role=\"button\" aria-pressed=\"true\" data-toggle=\"tooltip\" data-original-title=\"Ubah Data\">" +
                    "<span class=\"btn-inner--icon\"><i class=\"fas fa-file-invoice\"></i></span></a>" +
                    "<a href=\"/IIB9/" + data + "/edit\" class=\"btn btn-outline-info  btn-sm\" role=\"button\" aria-pressed=\"true\" data-toggle=\"tooltip\" data-original-title=\"Ubah Data\">" +
                    "<span class=\"btn-inner--icon\"><i class=\"fas fa-edit\"></i></span></a>" +
                    "<form class=\"d-inline\" id=\"formdelete" + data + "\" name=\"formdelete" + data + "\" onsubmit=\"deleteactivity('" + data + "','" + row.title + "')\" method=\"POST\" action=\"/IIB9/" + data + "\">" +
                    '@method("delete")' +
                    '@csrf' +
