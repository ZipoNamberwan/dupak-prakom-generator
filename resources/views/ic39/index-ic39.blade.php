                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="{{url('/IC39/generate-by-periode')}}" target="_blank" class="btn btn-outline-primary btn-round btn-icon mb-2" data-toggle="tooltip" data-original-title="Generate">
                            ...
                            <a href="{{url('/IC39/create')}}" class="btn btn-primary btn-round btn-icon mb-2" data-toggle="tooltip" data-original-title="Tambah Kegiatan">
