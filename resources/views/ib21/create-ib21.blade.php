                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="date" name="date" class="form-control @error('date') is-invalid @enderror" placeholder="Select date" type="date" value="{{ @old('date') }}" onchange="refreshAutoTitle()">
                                        @error('date')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                                ...
                                                <table class="table" width="100%" id="service-table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="px-1">1</td>
                                                            <td class="px-1">
                                                                <input id="serviceidfirst" type="hidden" name="serviceid[]" @if (old('serviceid.0')) value="{{ old('serviceid.0') }}" @endif>
                                                                <input id="servicedatefirst" name="servicedate[]" class="form-control @error('servicedate.0') is-invalid @enderror" placeholder="Select servicedate" type="date" value="{{ @old('servicedate.0') }}">
                                                                @error('servicedate.0')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                            ...
                                                            <td class="px-1">
                                                                <textarea id="descriptionfirst" class="form-control" name="description[]" rows="5">{{@old('description.0')}}</textarea>
                                                                @error('description.0')
                                                            ...
                                                            <td class="px-1">
                                                                <select id="servicetypefirst" name="servicetype[]" class="form-control" data-toggle="select">
                                                                    ...
                                                                    <option value="{{ $servicetype->id }}" @if (old('servicetype.0')) {{$servicetype->id == old('servicetype.0') ? 'selected' : ''}} @endif>
                                                                        {{ $servicetype->name }}
                                                                    </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <td class="px-1">
                                                                <select id="servicemediafirst" name="servicemedia[]" class="form-control" data-toggle="select">
                                                                    ...
                                                                    <option value="{{ $servicemedia->id }}" @if (old('servicemedia.0')) {{$servicemedia->id == old('servicemedia.0') ? 'selected' : ''}} @endif>
                                                                        {{ $servicemedia->name }}
                                                                    </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <td class="px-1">
                                                                <textarea id="servicefirst" class="form-control" name="service[]" rows="5">{{@old('service.0')}}</textarea>
                                                                @error('service.0')
                                                                <div class="error-feedback">
                                                                    {{$message}}
                                                                </div>
                                                            ...
                                                            <td class="px-1 pr-5">
                                                                <input class="form-control" type="text" id="requesterfirst" name="requester[]" @if (old('requester.0')) value="{{ old('requester.0') }}" @endif>
                                                                @error('requester.0')
                                                                <div class="error-feedback">
                                                                    kosong
                                                                </div>
                                                        ...
                                                        @for ($i = 1; $i < count(old('servicetype')); $i++) <tr>
                                                            ...
                                                            <td class="px-1">
                                                                <input type="hidden" name="serviceid[]" @if (old('serviceid'.$i)) value="{{ old('serviceid.'.$i) }}" @endif>
...
<script>
    var servicecount = @if(old('servicetype')) {{count(old('servicetype'))}} @else 1 @endif;
